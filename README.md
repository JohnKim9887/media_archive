...
## How it was made
This app uses React, typescript, mantine for frontend
The backend is managed by Supabase ( PosgreSQL )
The hosting is done by CloudFlare and development was done using Vite.
